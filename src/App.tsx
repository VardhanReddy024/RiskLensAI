  ...
  return (
    <div className="min-h-screen bg-enterprise-canvas text-slate-900 flex flex-col font-sans selection:bg-blue-600 selection:text-white">
      ...
      {activePage === 'landing' ? (
        ...
        <div className="flex-1 flex max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 gap-6 pb-24 lg:pb-12">
          {/* Floating Sidebar */}
            ...
            {activePage === 'razorpay' && (
              <RazorpayMonitorPage
                ...
                onNavigateToGraph={(txn) => {
                  setSelectedTransactionForInvestigation(txn);
