  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (msg.includes('auth/popup-closed-by-user')) {
        setError('Sign-in cancelled before selecting an account. Please try again.');
        ...
        setError(msg || 'Unable to complete Google authentication. Please select an account and try again.');
      }
      setSigningIn(false);
    }
  };
