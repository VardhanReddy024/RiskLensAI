    ...
    try {
      ...
      switch (errorCode) {
        case 'auth/configuration-not-found':
          setError(firebaseError.message || 'Firebase Authentication is not configured. Please provide VITE_FIREBASE_API_KEY in your .env or .env.local file.');
          break;
        case 'auth/invalid-api-key':
        case 'auth/api-key-not-valid':
          setError('Firebase API key is invalid. Please verify VITE_FIREBASE_API_KEY in your .env or .env.local file.');
          break;
