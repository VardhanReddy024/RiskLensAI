...
export interface Transaction {
  ...
  currency: string;
  merchant: string;
  merchantCategory: 'Electronics' | 'Luxury Goods' | 'Crypto Exchange' | 'Wire Transfer' | 'Gaming/Gambling' | 'Grocery' | 'Travel' | 'Retail' | 'Digital Goods' | 'Crypto';
  ...
  // Provider & Tenant Information (Razorpay / Multi-Tenant Ready)
  provider?: 'razorpay' | 'stripe' | 'manual' | string;
  ...
  riskFactors?: string[];
  riskDecision?: 'ALLOW' | 'REVIEW' | 'MITIGATE' | 'REJECT';
